...
#the edge_list is genrated from biomart script to get edge list 
#a_mat,lst_x_y= Create_Adjacency_Matrix(input("Type the name of the edge list file: "))
...
def main_2():
    ...
    df=pd.DataFrame(0,columns= lst_x_y, index= lst_x_y)
